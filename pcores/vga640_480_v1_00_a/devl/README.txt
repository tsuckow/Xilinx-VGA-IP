...
Peripheral Summary:
  ...
  XPS project / EDK repository               : /home2/thomas.suckow/CST455/edk_user_repository/MyProcessorIPLib
  logical library name                       : vga640_480_v1_00_a
  top name                                   : vga640_480
  version                                    : 1.00.a
  type                                       : PLB (v4.6) slave
...
Address Block for User Logic and IPIF Predefined Services
  ...
  interrupt control space                    : C_BASEADDR + 0x00000000
...
- XST synthesis file(s)
  ...
  devl/synthesis/vga640_480_xst.prj
...
- Driver interface file(s)
  ...
  data/vga640_480_v2_1_0.mdd

    This is the Microprocessor Driver Definition file.

  data/vga640_480_v2_1_0.tcl
...
plbv46_slave_single_v1_00_a
	/opt/pkg/Xilinx/10.1/EDK/hw/XilinxProcessorIPLib/pcores/plbv46_slave_single_v1_00_a/doc/plbv46_slave_single.pdf

interrupt_control_v2_00_a
	/opt/pkg/Xilinx/10.1/EDK/hw/XilinxProcessorIPLib/pcores/interrupt_control_v2_00_a/doc/interrupt_control.pdf
