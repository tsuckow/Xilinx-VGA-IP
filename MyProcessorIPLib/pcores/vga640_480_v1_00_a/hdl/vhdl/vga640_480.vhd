------------------------------------------------------------------------------
-- vga640_480.vhd - entity/architecture pair
------------------------------------------------------------------------------
-- IMPORTANT:
...
use vga640_480_v1_00_a.user_logic;
...
end entity vga640_480;

------------------------------------------------------------------------------
-- Architecture section
------------------------------------------------------------------------------

architecture IMP of vga640_480 is

  ------------------------------------------
  -- Array of base/high address pairs for each address range
  ------------------------------------------
  constant ZERO_ADDR_PAD                  : std_logic_vector(0 to 31) := (others => '0');
  constant INTR_BASEADDR                  : std_logic_vector     := C_BASEADDR or X"00000000";
  constant INTR_HIGHADDR                  : std_logic_vector     := C_BASEADDR or X"000000FF";
  ...
  constant IPIF_ARD_NUM_CE_ARRAY          : INTEGER_ARRAY_TYPE   := 
    (
      0  => INTR_NUM_CE,                  -- number of ce for interrupt control space
  ...
  -- Index for CS/CE
  ------------------------------------------
  constant INTR_CS_INDEX                  : integer              := 0;
...
begin
  ...
  ------------------------------------------
  USER_LOGIC_I : entity vga640_480_v1_00_a.user_logic
    generic map
    (
  ...
  ------------------------------------------
  IP2BUS_DATA_MUX_PROC : process( ipif_Bus2IP_CS, intr_IP2Bus_Data, user_IP2Bus_Data ) is
  begin

    case ipif_Bus2IP_CS is
      when "10" => ipif_IP2Bus_Data <= intr_IP2Bus_Data;
  ...
  ipif_IP2Bus_WrAck <= intr_IP2Bus_WrAck or user_IP2Bus_WrAck;
  ipif_IP2Bus_RdAck <= intr_IP2Bus_RdAck or user_IP2Bus_RdAck;
  ipif_IP2Bus_Error <= intr_IP2Bus_Error or user_IP2Bus_Error;
